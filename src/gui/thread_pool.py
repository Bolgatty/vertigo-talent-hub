...
import queue
from src.padma_import_resumeGUI import ResumeAnalyser
...
class ThreadPool:
    ...
    def __init__(self, func):
        ...
        self.running = 1
        self.thread1 = Thread(target=self.workerThread1,args=(func,))
        print(self.thread1)
        self.thread1.start()
        self.thread1.join()
    ...
    def workerThread1(self):
        ...
        while self.running:
            ...
            self.master = tk.Tk()
            self.gui_ra = GuiProgressbar(self.master, self.queue)
        ...
        # if (self.check_tagger == "save_candidate"):
        #     ResumeAnalyser().save_new_candidate_resume(self.data_list, self.file_path_ra)
...
'''
root = tk.Tk()
#client = ThreadedClient(root,"E:/Padma/LatestJobsA/LatestResume/Sahana_S_Resume.pdf")
root.mainloop()'''