...
class ImportResumeGUI:
    ...
    def initial_display(self):
        ...
        self.frame = tk.Frame(self.root, bg=self.bg_frame)
    ...
    def browse_resume(self):
        ...
        import_button = tk.Button(self.frame_import_panel, bg=self.import_button_color,
                                  fg=self.button_fg, font=self.button_font, text='Import', command=self.import_resume)
    ...
    def import_resume(self):
        ...
        if exception_test:
            ...
            # self.jsonstring = ResumeAnalyser().create_new_candidate(dict)
            try:
    ...
    def success_display(self, data):
        ...
        save_button = tk.Button(self.frame_import_confirmation, bg=self.button_color,
                                ...
                                command=lambda: self.save_candidate(data))
    ...
    def save_candidate(self, data):
        ...
        if check_duplicate:
            print('x')
            mb.showwarning('Duplicate Existing', 'Candidate ' + self.dict['name'] + 's resume is already existing!\n')
        else:
            ResumeAnalyser().save_candidate(data)
            print(data)
